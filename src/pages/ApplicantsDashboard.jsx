            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  Start your university application by choosing a programme.
                </p>
          ...
          <>
            ...
            {application.status === "Accepted" && (
              ...
              <div className="bg-green-50 border-l-4 border-green-600 rounded-xl p-6">
                ...
                <h3 className="text-xl font-bold mt-3 text-[#0A2342]">
            ...
            {application.status === "Rejected" && (
              ...
              <div className="bg-red-50 border-l-4 border-red-600 rounded-xl p-6">
                ...
                <p className="mt-3 text-gray-700">
                  Unfortunately, you have not been selected for enrollment at Bridgeview University.
                  Thank you for considering to study with us, we wish you the best ahead. for any further information please contact us.
                </p>
